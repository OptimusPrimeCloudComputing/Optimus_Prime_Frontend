...
function Account() {
  const { user, isAuthenticated, handleGoogleLogin } = useAuth()
      ...
      <section id="account" className="py-20 bg-gray-100">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg">Sign in to manage your orders and account</p>
          </div>
          ...
          <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Access your order history, manage your profile, and more.</p>
            <button
              onClick={handleGoogleLogin}
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 hover:shadow-md transition duration-300"
            >
